const e="/notes_computers_in_biology/assets/024_001-Cck3Ef7L.png",t="/notes_computers_in_biology/assets/024_002-lLue8aVD.png",n="/notes_computers_in_biology/assets/024_003-CJbqdFRS.png",o="/notes_computers_in_biology/assets/024_004-CNORRH3R.png",i="/notes_computers_in_biology/assets/024_005-LGuLcO-f.png",s={id:"RK-2026-024",title:"Pairwise Sequence Alignment with NCBI BLAST: Local vs. Global Alignment, BLASTn/BLASTp, and Result Interpretation",date:"2026-09-11",tags:["#BLAST","#SequenceAlignment","#bioinformatics"],type:"report",template:"standard",readTime:"20 min",author:{name:"RK Patel",role:"Microbiologist",avatar:"https://github.com/RKPatel-1996.png",affiliation:"Gujarat University"},excerpt:"A biology-oriented guide to pairwise sequence alignment using NCBI BLAST. It explains when local and global alignment are appropriate, how to run nucleotide and protein comparisons with BLASTn and BLASTp, and how to interpret the BLAST results table with particular attention to E-values, bit scores, query coverage, and percent identity.",content:`
<article>
  ...
  <figure class="science-figure" data-id="FIG-024-1" data-clean-src="${e}">
    <img src="${e}" alt="NCBI BLAST home page showing Nucleotide BLAST, translated BLAST options, and Protein BLAST" />
  ...
  <figure class="science-figure" data-id="FIG-024-2" data-clean-src="${t}">
    <img src="${t}" alt="NCBI Standard Nucleotide BLAST interface showing the query box, search set, program selection, and Align two or more sequences checkbox" />
  ...
  <figure class="science-figure" data-id="FIG-024-3" data-clean-src="${n}">
    <img src="${n}" alt="NCBI Standard Protein BLAST interface showing the protein query box, search set, blastp program selection, and Align two or more sequences checkbox" />
  ...
  <figure class="science-figure" data-id="FIG-024-4" data-clean-src="${o}">
    <img src="${o}" alt="NCBI BLAST Descriptions table showing significant nucleotide matches with columns for score, query cover, E-value, percent identity, subject length, and accession" />
  ...
  <figure class="science-figure" data-id="FIG-024-5" data-clean-src="${i}">
    <img src="${i}" alt="NCBI BLAST pairwise nucleotide alignment showing query and subject sequences, score, E-value, identities, gaps, and strand orientation" />
