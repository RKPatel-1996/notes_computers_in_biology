const i={id:"RK-2025-002",title:"Syllabus",date:"2026-07-05",tags:["#syllabus","#topics","#bioinformatics"],type:"report",template:"standard",readTime:"30 min",author:{name:"RK Patel",role:"Microbiologist",avatar:"https://github.com/RKPatel-1996.png",affiliation:"Gujarat University"},excerpt:"A comprehensive course syllabus covering the foundational progression from computer operations to practical computational biology. The curriculum explores Linux basics, laboratory spreadsheet data handling, and introductory Python and R programming, before advancing into biological databases, sequence formats, pairwise alignment algorithms, and structural bioinformatics.",content:`
  <article>
