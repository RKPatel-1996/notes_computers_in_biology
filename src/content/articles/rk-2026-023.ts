...
import f023_001 from "./article_images/f023_001.png";
import f023_002 from "./article_images/f023_002.png";
import f023_003 from "./article_images/f023_003.png";

const article: Article = {
  id: "RK-2026-023",
  title:
    "Practical -2: Retrieval of Structural and Experimental Information for PDB ID 4DKI ",
  date: "2026-02-26",
  tags: ["#Practical", "#PDB", "#bioinformatics"],
  type: "report",
  template: "standard",
  readTime: "30 min",
  author: {
...
<article>
    ...
    <ol>
        <li>Open a web browser and navigate to the official RCSB PDB website using a search engine or by typing the URL directly.
            <figure class="science-figure" data-id="Figure 1: " data-clean-src="${f023_001}">
                <img src="${f023_001}" alt="Google search for protein data bank" />
        ...
        <li>Enter the unique identifier <strong>"4DKI"</strong> into the primary search bar at the top of the PDB homepage and press Enter.
            <figure class="science-figure" data-id="Figure 2: " data-clean-src="${f023_002}">
                <img src="${f023_002}" alt="Searching for 4DKI on the PDB homepage" />
    ...
    <ol>
        <li>Carefully review the Structure Summary page. The requested metadata (authors, resolution, organism, etc.) is prominently displayed in the "Literature" and "Macromolecules" sections of this page.
            <figure class="science-figure" data-id="Figure 3: " data-clean-src="${f023_003}">
                <img src="${f023_003}" alt="Structure Summary page for 4DKI" />
